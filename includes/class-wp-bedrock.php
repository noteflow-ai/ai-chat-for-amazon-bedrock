...
class WP_Bedrock {
    ...
    public function __construct() {
        if (defined('AICHAT_BEDROCK_VERSION')) {
    ...
    private function load_dependencies() {
        ...
        /**
         * The class responsible for AWS Bedrock API interactions.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-wp-bedrock-aws.php';
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('admin_init', $plugin_admin, 'process_settings_form');
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action('wp_ajax_aichat_bedrock_send_message', $plugin_public, 'handle_send_message');
        $this->loader->add_action('wp_ajax_nopriv_aichat_bedrock_send_message', $plugin_public, 'handle_send_message');
    }
     ...
     *
     * @since     1.0.0
     * @return    WP_Bedrock_Loader    Orchestrates the hooks of the plugin.
     */
